...
public class PrediccionJugador {
	@Id
	...
	public PrediccionJugador() {
	}
	
	public PrediccionJugador(Long id_Partido, Long id_Usuario, Long resA, Long resB, Long puntos) {
	...
	public String toString() {
		return "PrediccionJugador [id_Prediccion=" + id_Prediccion + ", id_Partido=" + id_Partido + ", id_Usuario="
